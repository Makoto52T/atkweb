        ...
        <div style="margin-bottom: 50px;">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="text-center"><img src="images/article/Reellove/reel-love_s_scatter.png.webp"></div>
                    <div style="margin-bottom: 50px;">
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="text-center"><img src="images/article/Reellove/reel-love_s_wild.png.webp"></div>
                    <div style="margin-bottom: 50px;">
                        <span style="color: white;font-weight: bold;font-size: 26px;">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="text-center"><img src="images/article/Reellove/reel-love_s_freespin.png.webp"></div>
                    <div class="htext text-center" style="margin-bottom: 20px;">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="text-center"><img src="images/article/Reellove/reel-love_h_green.png.webp"></div>
                    <div class="htext text-center" style="margin-bottom: 20px;">
            ...
            <div class="text-center" style="margin: 50px;">
                <img src="images/article/Reellove/เกมสล็อต-Reel-Love-298x530-min.jpg.webp">
            </div>
        </div>
    </div>
</div>
