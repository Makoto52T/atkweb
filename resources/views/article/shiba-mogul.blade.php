    ...
    <div class="col-lg-10">
        ...
        <div class="text-center" style="margin-bottom: 50px;">
            <div class="row">
                <div class="col-lg-4">
                    <div style="margin-bottom: 50px;">
                        <span style="color: white;font-size: 28px;">Game Type</span>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div style="margin-bottom: 50px;">
                        <span style="color: white;font-size: 28px;">Compatible with</span>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div style="margin-bottom: 50px;">
                        <span style="color: white;font-size: 28px;">Language</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div style="margin-bottom: 50px;">
                        <span style="color: white;font-size: 28px;">3D Games, Video Slots</span>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div style="margin-bottom: 50px;">
                        <span style="color: white;font-size: 28px;">iOS Android Windows Mac OS HTML5</span>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="text-center" style="margin-bottom: 50px;">
        ...
        <div style="margin-bottom: 50px;">
            <div class="row" style="margin-bottom: 20px;">
                <div class="text-center"><span style="font-size: 30px;color: #eeb013;">สัญลักษณ์พิเศษต่าง ๆ</span></div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-6 col-md-2 text-center">
                    ...
                    <div>
                        <span style="font-weight: bold;font-size: 28px;">Bonus Symbol</span>
                    </div>
                    <div>
                        <span style="color: white;font-weight: bold;font-size: 26px;">
                ...
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="gb-container gb-container-8426a28c" style="margin-bottom: 100px;">
                                <div style="margin: 10px;">
                                    <span style="font-weight: bold;font-size: 28px;">สัญลักษณ์ สุนัขชิบะแดง</span>
                                </div>
                                <div style="margin: 10px;">
                        ...
                        <div class="col-lg-6">
                            <div class="gb-container gb-container-8426a28c" style="margin-bottom: 100px;">
                                <div style="margin: 10px;">
                                    <span style="font-weight: bold;font-size: 28px;">สัญลักษณ์ สุนัขชิบะดำ</span>
                                </div>
                                <div style="margin: 10px;">
                                    <span style="font-size: 26px;color: white;font-weight: bold;">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="gb-container gb-container-8426a28c" style="margin-bottom: 100px;">
                                <div style="margin: 10px;">
                                    <span style="font-weight: bold;font-size: 28px;">สัญลักษณ์ สุนัขชิบะโจรสลัด</span>
                                </div>
                                <div style="margin: 10px;">
                                    <span style="font-size: 26px;color: white;font-weight: bold;">
                        ...
                        <div class="col-lg-6">
                            <div class="gb-container gb-container-8426a28c" style="margin-bottom: 100px;">
                                <div style="margin: 10px;">
                                    <span style="font-weight: bold;font-size: 28px;">สัญลักษณ์ A</span>
                                </div>
                                <div style="margin: 10px;">
                                    <span style="font-size: 26px;color: white;font-weight: bold;">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="gb-container gb-container-8426a28c" style="margin-bottom: 50px;">
                                <div style="margin: 10px;">
                                    <span style="font-weight: bold;font-size: 28px;">สัญลักษณ์ K</span>
                                </div>
                                <div style="margin: 10px;">
                                    <span style="font-size: 26px;color: white;font-weight: bold;">
                        ...
                        <div class="col-lg-6">
                            <div class="gb-container gb-container-8426a28c" style="margin-bottom: 50px;">
                                <div style="margin: 10px;">
                                    <span style="font-weight: bold;font-size: 28px;">สัญลักษณ์ Q</span>
                                </div>
                                <div style="margin: 10px;">
                                    <span style="font-size: 26px;color: white;font-weight: bold;">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="gb-container gb-container-8426a28c" style="margin-bottom: 50px;">
                                <div style="margin: 10px;">
                                    <span style="font-weight: bold;font-size: 28px;">สัญลักษณ์ J</span>
                                </div>
                                <div style="margin: 10px;">
                                    <span style="font-size: 26px;color: white;font-weight: bold;">
