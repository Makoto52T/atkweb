        ...
        <div style="margin-bottom: 50px;">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    ...
                    <div style="margin-bottom: 20px;">
                        <span style="font-size: 18px;color: white;font-weight: bold;">
                            สล็อต Wildbandito มีสัญลักษณ์ Scatter เป็นรูป หัวกระโหลก ที่จะทำให้ทุกคนได้รับรางวัลโบนัส ฟรีสปิน
                        </span>
                    </div>
                    <div class="text-center"><img src="images/article/Wildbandito/wild-bandito_s_scatter-min.png.webp"></div>
                    <div style="margin-bottom: 50px;">
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="text-center"><img src="images/article/Wildbandito/wild-bandito_s_wild-min.png.webp"></div>
                    <div style="margin-bottom: 50px;">
                        <span style="color: white;font-size: 26px;font-weight: bold;">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="text-center"><img src="images/article/Wildbandito/wild-bandito_h_skeleton-min.png.webp"></div>
                    <div class="htext text-center" style="margin-bottom: 20px;">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="text-center"><img src="images/article/Wildbandito/wild-bandito_h_guitar.png.webp"></div>
                    <div class="htext text-center" style="margin-bottom: 20px;">
            ...
            <div class="text-center" style="margin: 50px;">
                <img src="images/article/Wildbandito/Wild-Bandito-new2-min.jpg.webp">
            </div>
        </div>
    </div>
</div>
