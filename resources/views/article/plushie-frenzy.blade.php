...
<div class="row">
    ...
    <div class="col-lg-10 col-md-12">
        ...
        <div class="text-center" style="margin-bottom: 50px;">
            <img src="images/article/Plushiefrenzy/Plushie-Frenzy_icon.png.webp" style="width: 30%;">
        </div>
        ...
        <div style="margin-bottom: 50px;">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="text-center"><img src="images/article/Plushiefrenzy/PlushieFrenzy_Scatter.png.webp"></div>
                    <div style="margin-bottom: 50px;">
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="text-center"><img src="images/article/Plushiefrenzy/PlushieFrenzy_Wild.png.webp"></div>
                    <div style="margin-bottom: 50px;">
                        <span style="color: white;font-weight: bold;font-size: 26px;">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="text-center"><img src="images/article/Plushiefrenzy/PlushieFrenzy_Lion.png.webp"></div>
                    <div class="htext text-center" style="margin-bottom: 20px;">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="text-center"><img src="images/article/Plushiefrenzy/PlushieFrenzy_Tiger.png.webp"></div>
                    <div class="htext text-center" style="margin-bottom: 20px;">
                        <span style="font-weight: bold;font-size: 28px;">สัญลักษณ์ พิเศษ</span>
                    </div>
                    <div style="margin-bottom: 20px;">
            ...
            <div class="text-center" style="margin: 50px;">
                <img src="images/article/Plushiefrenzy/เกมสล็อต-Plushie-Frenzy-Big-win.jpg.webp">
            </div>
        </div>
    </div>
</div>
