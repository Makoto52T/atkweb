...
Route::get('/article/piggy-gold', function () {return view('article/piggy-gold');});
Route::get('/article/phoenix-rises', function () {return view('article/phoenix-rises');});
Route::get('/article/romo-plus', function () {return view('article/romo-plus');});
Route::get('/article/dragon-hatch', function () {return view('article/dragon-hatch');});
Route::get('/article/jurssic-kingdom', function () {return view('article/jurssic-kingdom');});
Route::get('/article/ganesha-gold', function () {return view('article/ganesha-gold');});
...
Route::get('/article/reel-Love', function () {return view('article/reel-Love');});
Route::get('/article/legend-of-hou-yi', function () {return view('article/legend-of-hou-yi');});
Route::get('/article/egypt', function () {return view('article/egypt');});
Route::get('/article/mahjong-ways', function () {return view('article/mahjong-ways');});
Route::get('/article/galactic-gems', function () {return view('article/galactic-gems');});
Route::get('/article/crypto-gold', function () {return view('article/crypto-gold');});
Route::get('/article/majestic-treasures', function () {return view('article/majestic-treasures');});
Route::get('/article/plushie-frenzy', function () {return view('article/plushie-frenzy');});
Route::get('/article/mr.hallow-win', function () {return view('article/mr.hallow-win');});
Route::get('/article/flirting-scholar', function () {return view('article/flirting-scholar');});
